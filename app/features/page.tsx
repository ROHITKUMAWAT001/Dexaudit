...
export default function FeaturesPage() {
  return (
    <main className="pt-16 selection:bg-primary/10 selection:text-primary">
      <div className="border-b border-slate-100 bg-slate-50/50 py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            From ghost seat detection to plan arbitrage, DexAudit provides the surgical precision
            required to manage modern engineering capital.
          </p>
        </div>
      </div>
