...
**Definition:** The number of unique audits generated where the identified savings exceed $500/month *and* the user successfully un-gates the report by providing a verified work email.
...
**The Pivot Action:** We will immediately remove the email gate, make the entire report 100% free and open, and instead rely entirely on the "Book Migration Strategy" CTA embedded *within* the final report to generate leads. We trade volume of leads for extreme high-intent leads.