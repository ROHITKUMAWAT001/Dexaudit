...
- _Attempt 1:_ Just sending the tool names. The AI hallucinated savings numbers that didn't match our defensible audit engine. Fix: Pass the calculated results array.
- _Attempt 2:_ Allowing markdown. The AI returned bulleted lists that looked terrible inside the specific summary card UI component. Fix: Explicitly banned markdown.
- _Attempt 3:_ Using a generic system prompt. The tone felt too conversational ("Hi there! Here is your audit..."). Fix: Enforced the "surgical, B2B" tone rule.
